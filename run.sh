...
$FVP_BIN $OPTIONS -a cpu_core.cpu0*="build/bootloader/bl2.axf" --data "build/secure_partition/tfm_s_signed.bin"@0x38000000 --data "build/kws/tfm_ns_signed.bin"@0x28060000

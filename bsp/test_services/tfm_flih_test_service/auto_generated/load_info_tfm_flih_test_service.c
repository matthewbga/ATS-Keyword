...
const struct partition_tfm_sp_flih_test_load_info_t tfm_sp_flih_test_load
    ...
    .assets                         = {
        {
            .mem.addr_x             = PART_REGION_ADDR(PT_TFM_SP_FLIH_TEST_PRIVATE, _DATA_START$$Base),
            .mem.addr_y             = PART_REGION_ADDR(PT_TFM_SP_FLIH_TEST_PRIVATE, _DATA_END$$Base),
            .attr                   = ASSET_MEM_RD_BIT | ASSET_MEM_WR_BIT,
        },
        {
            .dev.addr_ref           = PTR_TO_REFERENCE(TFM_PERIPHERAL_TIMER0),
    ...
    .irqs = {
        {
            ...
            .flih_func = (uint32_t)tfm_timer0_irq_flih,
